...
let plain_content = [
    ...
    ["p",
    "I began my professional life as a videogame and computer rental store assistant. I was 13 at the time. It was a passion to go to this public place where they sold comics and leased play stations 1 for a few pesos an hour, I think it was $10 or about 2 600 ml cocacolas worth of money then. (today one coca is worth $18 pesos)",
    "Comenze mi vida profesional como un asistente en tiendas de renta de videjuegos y computadoras. Tenía 13 años en aquel entonces, Era una pasión mia el ir a este lugar donde vendían comics y rentaban play stations 1 por unos cuantos pesos por hora, algo así como $10 o bien 2 cocas de 600 ml de aquel entonces. (hoy una coca is worth $18 pesos)"
    ],
    ["p",
    ...
    ["p",
    "It is some sort of duty, to leave some of us in our wake. Our own approach, the small story of an individual in this sea of humanity. Machines can work data that simbolyses ideas. And it can perform amazing feats on the material reality we belong to. This path of life is just learning how that power works, ¿how it can be employed?, ¿who has already done what in what ways? and finally: ¿What do we want to do with this power ourselves?.",
    "Tenemos un deber tácito de dejar algo en nuestro camino, nuestra propia aproximación, la historia de un individuo en este mar de humanidad. Las máquinas puedent trabajar datos que simbolizan ideas, y pueden lograr cosas impresionantes en la realidad material a la que pertencemos. Este camino de aprendizaje es aprender como funciona ese poder, como puede ser empleado, quien ha hecho que cosas con el ya y finalmente ¿Qué queremos hacer con este poder nosotros mismos?"
    ],
    ["p",
