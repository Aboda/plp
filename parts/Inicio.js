...
d.insigths = {
  "flux":{
    "aproximation":"reality is in constant iteration of itself, its ability to transform is great, its coherence, variable"
  },
  "xotello":{
    "aproximation":"the exchange between omno and umno",
    "qualities":{
      "cygny":"the power in knowledge",
      "greas":"the wisdom of life",
    }
  },
  "omno":{
    "aproximation":"the world that lies beyond the crocia",
    "qualities":{
      "reico":"focus and identification of the exterior"
    }
  },
  "crocia":{
    "aproximation":"definition and individuality",
    "qualities":{
      "crat":"awareness of thresholds"
    }
  },
  "umno":{
    "aproximation":"the interior world",
    "qualities":{
      "ennen":"awareness and understanding of the interior",
      "esna":"the ability to perpetuate, preserve and resist",
      "mnem":"the ability to remember events past",
      "vris":"the ability to predict the future",
      "slis":"the ability to adapt"
    }
  },
  "extrota":{
    "the crone has seen change comming":{
      "ends":"change demands change",
      "treasure":"change opens doors",
      "quest":"rise up for the challenge"
    }
  }
}

d.dimensions_of_conflict = {
  "existance_planes":{
    "Physical":true,
    "Cognitive":true,
    "Metaphysical":true,
      ...
      "cnt":{
        ...
        "Acerca de mi":{
          ...
          "dynamics":{
            ...
            "styles":["card_space"],
            "texts":{
              "es":"¿Quién soy?,¿Dónde estoy?,¿Porque hago esto?",
              "en":"Who am I?, Where am I?, Why am I doing this?"
            }
          },
        ...
        "Automatización y Programación":{
          ...
          "order":2,
          "texts":{
            "es":"Automatización y Programación",
            "en":"Automatization and Programming",
          },
          "dynamics":{
            "type":"expand_main_opt",
            "styles":["card_space"],
  ...
  for (var name in structure) {
    ...
    if (item.dynamics != undefined) {
      ...
      if (item.dynamics.type == "expand_main_opt") {
        ...
        expanded_text.classList.add("hidden");
        built.append(expanded_text);
        built.addEventListener("click",function(){
          console.log(this.childNodes);
          for (var i = 1; i < this.childNodes.length ; i++) {
            this.childNodes[i].classList.toggle("hidden");
          };
        })
      }
